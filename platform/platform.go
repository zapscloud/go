...
// HttpGet - HTTP Get Request
func (p *ZapsPlatform) HttpPost(requrl string, body []byte) (map[string]interface{}, error) {
...
func (p *ZapsPlatform) HttpPut(requrl string, body []byte) (map[string]interface{}, error) {
